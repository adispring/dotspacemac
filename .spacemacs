...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(paredit smex yasnippet company nodejs-repl expand-region simple-httpd window-numbering)
